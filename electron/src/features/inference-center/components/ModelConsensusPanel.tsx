      ...
      <div className="flex items-center justify-between pb-3 border-b border-slate-100 mb-3">
        <div className="flex items-center gap-2">
          ...
          <div>
            ...
            <p className="text-[11px] text-slate-600 m-0">异构多模型对同一标的的综合预测研判</p>
          </div>
        </div>
        <div className="flex items-center gap-1.5 bg-blue-50 border border-blue-100 px-3 py-1 rounded-xl">
          <span className="text-[11px] text-slate-700 font-semibold">综合共识得分:</span>
        ...
        {consensus.length === 0 ? (
          selectedCount > 0 ? (
            <div className="col-span-2 flex flex-col items-center justify-center gap-2 py-8 text-center">
              ...
              <p className="text-xs font-semibold text-slate-700 m-0">所选 {selectedCount} 个模型当日均无持久化分数</p>
            ...
            <div className="col-span-2 flex flex-col items-center justify-center gap-2 py-8 text-center">
              ...
              <p className="text-xs font-semibold text-slate-700 m-0">暂无多模型共识数据</p>
          ...
          consensus.map((item, idx) => (
            ...
            >
              ...
              <div className="flex items-center justify-between pt-2 border-t border-slate-50">
                <span className="text-[11px] text-slate-600 font-medium">模型信号分数</span>
