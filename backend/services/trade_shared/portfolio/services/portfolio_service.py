...
from backend.services.trade_shared.models.enums import PositionSide
from backend.services.trade_shared.portfolio.config import settings
from backend.services.trade_shared.portfolio.models import (
    Portfolio,
    PortfolioSnapshot,
    Position,
)
from backend.services.trade_shared.portfolio.schemas import PortfolioCreate, PortfolioUpdate
from backend.services.trade_shared.portfolio.services.remote_service import remote_service
from backend.services.trade_shared.portfolio.utils import cache, get_cache_key
...
class PortfolioService:
    ...
    async def calculate_portfolio_metrics(db: AsyncSession, portfolio: Portfolio) -> Portfolio:
        ...
        from backend.services.trade_shared.portfolio.utils.risk_metrics import (
