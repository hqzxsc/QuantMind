...
const SkillsCenterPage: React.FC = () => {
  ...
  const [tab, setTab] = useState<SkillsTab>('prompts');
            ...
            <div className="flex items-center gap-1 rounded-full bg-slate-100 border border-slate-200 p-0.5">
              <button
                ...
                className={`flex items-center gap-1.5 rounded-full px-3 py-1 text-[11px] font-bold transition-colors ${
                  tab === 'prompts' ? 'bg-white text-slate-800 shadow-sm' : 'text-slate-500 hover:text-slate-700'
                }`}
              >
              ...
              <button
                onClick={() => setTab('factor-report')}
                className={`flex items-center gap-1.5 rounded-full px-3 py-1 text-[11px] font-bold transition-colors ${
                  tab === 'factor-report' ? 'bg-white text-slate-800 shadow-sm' : 'text-slate-500 hover:text-slate-700'
                }`}
              >
