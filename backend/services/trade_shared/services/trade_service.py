...
from backend.services.trade_shared.schemas.trade import TradeListQuery
...
class TradeService:
    ...
    async def create_trade(
        ...
        try:
            from backend.services.trade_shared.portfolio.services.position_service import PositionService
            sync_data = TradeSync(
