...
from backend.services.trade_shared.models.order import Order, OrderStatus, TradingMode
from backend.services.trade_shared.redis_client import RedisClient
from backend.services.live_trading.services.broker_client import BaseBroker, create_broker
...
class TradingEngine:
    ...
    async def rotate_buy_next(self, user_id: int, portfolio_id: int, original_symbol: str) -> dict | None:
        ...
        try:
            from backend.services.trade_shared.portfolio.models import Portfolio
            from backend.services.trade_shared.models.order import Order, OrderStatus
            ...
            # 获取当前持仓
            from backend.services.trade_shared.models.position import Position
