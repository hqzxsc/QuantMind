...
export const PROMPTS: PromptMeta[] = [
  ...
  },
  {
    ...
    outputs: '安装结果',
    body: `请帮我安装/启动富途 OpenD 网关：{本机安装 / Docker 运行（docker compose up -d futu-opend）/ 升级 futu-api SDK}。\n\n请读取 skills/install-futu-opend/SKILL.md 并按流程执行，完成后验证 OpenD 连接（端口 11111）可用。`,
  },
  {
    name: 'tigeropen',
